...
function checkAll() {
    ...
    $.when(
        ...
        if (json[0].status == 1) {
            ...
            window.location.replace(URL + "courseAdded");
        } else {
...
/**
 * Metodo che fa una richiesta al server per aggiungere un corso.
 * @param formData Il corso da aggiungere.
