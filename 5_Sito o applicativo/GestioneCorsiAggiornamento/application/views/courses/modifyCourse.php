...
<div class="main-content-inner">
                ...
                <div class="col-12" style="margin-top: 100px">
                    <div class="card">
                        <div class="card-body col-md-9 col-sm-12" style="margin: auto">
                            <h2 class="mb-5 text-center">Modifica corso</h2>
                            <form>
                                <div class="row">
                                    <div class="col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control"
                                                   value="<?php echo $course[DB_COURSE_TITLE]; ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control"
                                                   value="<?php echo $course[DB_COURSE_STREET]; ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control"
                                                   value="<?php echo $course[DB_COURSE_ZIP]; ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-sm-12">
                                        <div class="form-group">
                                            <label>Città<span class="obligatory">*</span> <i class="fa fa-info-circle"
                                                                                             ...
                                                                                             data-content="3-50 caratteri, lettere, numeri e caratteri da scrittura"></i></label>
                                            <input type="text" class="form-control"
                                                   value="<?php echo $course[DB_COURSE_CITY]; ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="number" min="0" class="form-control"
                                                   value="<?php echo $course[DB_COURSE_MAX_PARTECIPANTS]; ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <select id="cars" class="form-control" style="height: 45px">
                                                <?php foreach ($typologies as $t): ?>
                                                    <option <?php echo ($course[DB_COURSE_TYPOLOGY] == $t[NAME_TYPOLOGY]) ? "selected" : ""; ?>
                                                            value="<?php echo $t[NAME_TYPOLOGY]; ?>"><?php echo $t[NAME_TYPOLOGY]; ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="number" min="0" class="form-control"
                                                   value="<?php echo $course[DB_COURSE_COURSE_PRICE]; ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="number" min="0" class="form-control"
                                                   value="<?php echo $course[DB_COURSE_MEAL_PRICE]; ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-12">
                                        <label>Descrizione<span class="obligatory">*</span> <i class="fa fa-info-circle"
                                                                                               ...
                                                                                               data-toggle="popover"
                                                                                               data-placement="top"
                                                                                               data-content="Solo lettere, numeri e caratteri da scrittura"
                                                                                               data-toggle="tooltip"></i></label>
                                        <div class="form-group">
                                            <textarea type="text" id="text_modal_input"
                                                      class="form-control"><?php echo $course[DB_COURSE_DESCRIPTION]; ?></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="form-group">
                                            <textarea type="text" id="text_modal_input"
                                                      class="form-control"><?php echo $course[DB_COURSE_MATERIALS]; ?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </form>
                                ...
                                <div class="col-md-6 col-sm-12 pb--10">
                                    <div class="input-group">
                                        <a class="btn btn-info btn-lg btn-block" onclick="checkAll()"
                                           style="color: white">Modifica corso
                                        </a>
                                    </div>
                                </div>
                                <div class="col-md-6 col-sm-12">
    ...
    <script src="js/modifyCourse.js"></script>