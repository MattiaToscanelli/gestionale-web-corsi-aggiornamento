        ...
        <div class="login-box ptb--100">
            <form>
                <div class="login-form-head">
                    <h4>Corso modificato!</h4>
                </div>
                <div class="login-form-body">
                    <div class="form-gp text-center">
                        <p>Il corso è stato modificato con successo!</p>
                    </div>
                    <div class="submit-btn-area">
                        <a class="btn btn-info mb-3 w-100" href="<?php echo URL . 'managementCourses'; ?>"
                           role="button">Ritorna
                            alla gestione corsi</a>
                    </div>
                </div>
            </form>
        </div>
